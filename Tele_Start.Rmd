...
tele_ANN1 <- neuralnet(formula = yyes ~ .,
                              data = tele_train)
plot(tele_ANN1)
# model 1 :results
...
# model 1 matrix
confusionMatrix(as.factor(p_yes), as.numeric(tele_test$yyes), positive="1")
